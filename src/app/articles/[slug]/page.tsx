    ...
    <>
      ...
      <article className="px-6 py-section">
        <div className="prose max-w-article mx-auto">
          {article.pdfUrl && (
            <div className="mb-10 p-6 bg-parchment border border-border-subtle rounded-sm">
              <a
                href={article.pdfUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-saffron text-white text-sm font-medium rounded-sm hover:bg-saffron-dark transition-colors no-underline"
              >
